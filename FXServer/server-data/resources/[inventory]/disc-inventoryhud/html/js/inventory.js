        ...
        if (itemData !== undefined) {
            ...
            if (!itemData.unique) {
                if (itemData.stackable) {
                    $('.tooltip-div').find('.tooltip-uniqueness').html("Vienādi - Max (" + itemData.max + ")");
                } else {
                    $('.tooltip-div').find('.tooltip-uniqueness').html("Vienādi - Nesavienojami");
                }
            } else {
                $('.tooltip-div').find('.tooltip-uniqueness').html("Dažādi (" + itemData.max + ")");
            }

            if (itemData.description !== undefined) {
                $('.tooltip-div').find('.tooltip-desc').html(itemData.description);
            } else {
                $('.tooltip-div').find('.tooltip-desc').html("Nav informācijas");
            }

            if (itemData.weight !== undefined) {
                $('.tooltip-div').find('.tooltip-weight').html('Svars: ' + itemData.weight * itemData.qty);
            } else {
