...
RegisterNetEvent('disc-inventoryhud:stopLoad')
AddEventHandler('disc-inventoryhud:stopLoad', function(job)
    invLoaded = true
end)
...
Citizen.CreateThread(function()
    while invLoaded == false do
        Citizen.Wait(10000)
        TriggerServerEvent('disc-inventoryhud:ensureInv', GetPlayerServerId(PlayerId()))
    end
    print("Loaded latest version of players inventory")
end)
