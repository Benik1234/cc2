...
function closeInventory()
    ...
    if secondInventory ~= nil then
        ...
        TriggerServerEvent('disc-inventoryhud:saveInventory', secondInventory.owner, secondInventory.type)

    end
    if ESX.GetPlayerData().identifier ~= nil then
        TriggerServerEvent('disc-inventoryhud:saveInventory', ESX.GetPlayerData().identifier, 'player')
    end
